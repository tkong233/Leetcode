...
public class GFG { 
    ...
    static Set<String> stale(String[][] preTasks, ImmutableMap<String, String> times) {
...
{"mapper","reducer"},
{"metadata","timestamp"}};
        ImmutableMap<String, String> imap2 = 
                        ImmutableMap.<String, String>builder() 
                                                .put("clean", "20170302-1129") 
                                                .put("mapper", "20170302-1155")
                                                .put("update", "20170302-1150")
                                                .put("statistics", "20170302-1153")
                                                .put("metadata", "20170302-1130")
                                                .put("reducer", "20170302-1540")
                                                .build(); 
